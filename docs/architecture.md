...
| Databricks Batch 1 job run screenshot | `images/databricks_qa/databricks_job_batch1_initial.png` |
| Databricks Batch 2 job run screenshot | `images/databricks_qa/databricks_job_batch2_incremental.png` |
| ADF Databricks wrapper run screenshot | `images/databricks_qa/adf_pipeline_debug_success.png` |

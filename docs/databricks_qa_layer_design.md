...
Power BI evidence is stored in `powerbi/screenshots/`. The SQL Warehouse used for Power BI import was stopped after refresh for cost control.
...
| Evidence | Location |
|---|---|
| Databricks Batch 1 job run | `images/databricks_qa/databricks_job_batch1_initial.png` |
| Databricks Batch 2 job run | `images/databricks_qa/databricks_job_batch2_incremental.png` |
| ADF pipeline wrapper run | `images/databricks_qa/adf_pipeline_debug_success.png` |

...
|---|---|---|---|---|
| Batch 1 | `scripts/shared/generate_synthetic_data.py` | `2025-01-15` | 2024 | Initial baseline load |
| Batch 2 | `scripts/shared/generate_synthetic_batch_2.py` | `2026-01-15` | 2025 | Incremental annual rollover |

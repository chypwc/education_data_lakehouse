...
| Evidence | Location |
|---|---|
| Data quality SQL | `sql/pipeline_a_synapse_baseline/06_data_quality_checks.sql` |
| Validation result screenshot | `images/pipeline_a_synapse_baseline/dq_validation_results.png` |
